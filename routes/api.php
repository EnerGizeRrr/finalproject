...
use App\Http\Controllers\Api\V1\AuthController; // Добавляем AuthController
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;

// Маршруты для аутентификации (login, register)
...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    Route::get('/projects/{project}/tasks/cursor', [TaskController::class, 'indexByCursor'])->name('tasks.indexByCursor');
